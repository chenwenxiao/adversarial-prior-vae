...
def main():
    ...
    with tf.name_scope('optimizing'):
        ...
        with tf.name_scope('plotting'):
            ...
            plot_net = p_net(n_z=sample_n_z, mcmc_iterator=3, beta=beta, initial_z=initial_z)
    ...
    with spt.utils.create_session().as_default() as session, \
        ...
        # else:
        restore_checkpoint = '/mnt/mfs/mlstorage-experiments/cwx17/72/1c/d434dabfcaec62bb97e5/checkpoint/checkpoint/checkpoint.dat-374400'
