...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.9\columnwidth]{../figures/loss_curves_1}
	\caption{
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.9\columnwidth]{../figures/fid_is_nll_on_different_dim_1}
	\caption{
...
To valid the assumption in \cref{subsec:inference} holds in actual experiment, we calculate $|\E_{p_\theta(x|z)}D(x) - D(G(z))|$ (0.0483) on CIFAR-10, which is acceptable small. To valid the intuition in \cref{subsec:intuition}, we visualize the discriminator of images in \cref{fig:interpolate}. 
