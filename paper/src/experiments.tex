...
\begin{figure}[tb]
	...
	\caption{
	The discriminators on above images, are better at both sides and worse at mid, which validates the intuition that discriminator can assess the quality of images. 
