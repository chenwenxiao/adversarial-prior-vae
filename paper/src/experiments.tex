...
To validate the assumption introduced in \cref{subsec:inference} indeed holds in practical experiment, $|\E_{p_\theta(x|z)}D(x) - D(G(z))|$ is an acceptable value (0.019) on CIFAR-10. 
