...
\subsection{Baseline training} \label{subsec:naive_vaepp}
...
\begin{algorithm}[tb]
\caption{Baseline training algorithm for VAEPP}
\label{alg:vaepp}
...
\subsection{Combing training} \label{subsec:improve_of_vaepp}
