...
Thanks to the stable and efficient gradient penalty regularizer term provided by WGAN-GP and WGAN-div, we enjoy stable and efficient training. We will call the model trained by \cref{alg:vaepp} Naive VAEPP and the model trained by \cref{alg:improved_vaepp} VAEPP. 
\begin{algorithm}[tb]
